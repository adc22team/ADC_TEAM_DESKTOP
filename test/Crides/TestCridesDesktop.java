...
public class TestCridesDesktop {
    ...
    /**
     * Fa l'inici de sessió d'un usuari amb rol d'administrador 
     * pasat per parametre a la crida
     * @param usuari
     * @param contrasenya
     * @param id
    ...
    /**
     * Fa l'inici de sessió d'un usuari amb rol de tècnic 
     * pasat per parametre a la crida
     * @param usuari
     * @param contrasenya
     * @param id
    ...
    /**
     * Fa l'inici de sessió d'un usuari amb rol d'usuari 
     * pasat per parametre a la crida
     * @param usuari
     * @param contrasenya
     * @param id
    ...
    /**
     * * Fa l'inici de sessió d'un usuari incorrecte 
     * pasat per parametre a la crida
     * @param usuari
     * @param contrasenya
     * @param id
