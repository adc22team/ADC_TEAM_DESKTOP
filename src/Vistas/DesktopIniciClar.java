 ...
 * @author garci
 */
public class DesktopIniciClar extends javax.swing.JFrame {
    ...
    public static void setUsuari(String usuari) {
        DesktopIniciClar.usuari = usuari;
    }
     static String pwd;
    ...
    public static void setId(int id) {
        DesktopIniciClar.id = id;
    }
    /**
     * Creates new form DesktopPrincipal
     */
    public DesktopIniciClar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DesktopIniciClar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DesktopIniciClar().setVisible(true);
            }
        });
    }
...
private void logOut(){
    ...
    try {
        ...
        Logger.getLogger(DesktopIniciClar.class.getName()).log(Level.SEVERE, null, ex);
    }
