 ...
 * @author garci
 */
public class DesktopConfiguracioFosc extends javax.swing.JFrame {
    ...
    public static void setRol(int rol) {
        DesktopConfiguracioFosc.rol = rol;
    }
    ...
    public static void setUsuari(String usuari) {
        DesktopConfiguracioFosc.usuari = usuari;
    }
     static String pwd;
    ...
    public static void setPwd(String pwd) {
        DesktopConfiguracioFosc.pwd = pwd;
    }
    ...
    public static void setId(int id) {
        DesktopConfiguracioFosc.id = id;
    }
    /**
     * Creates new form DesktopPrincipal
     */
    public DesktopConfiguracioFosc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelHome.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/01 Inici NoSelected.png"))); // NOI18N
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(117, 500));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        DesktopConfiguracioClar window = new DesktopConfiguracioClar();
        window.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DesktopConfiguracioFosc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DesktopConfiguracioFosc().setVisible(true);
            }
        });
    }
...
private void logOut(){
    ...
    try {
        ...
        Logger.getLogger(DesktopConfiguracioFosc.class.getName()).log(Level.SEVERE, null, ex);
    }
