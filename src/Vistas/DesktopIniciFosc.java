 ...
 * @author garci
 */
public class DesktopIniciFosc extends javax.swing.JFrame {
    ...
    public static void setUsuari(String usuari) {
        DesktopIniciFosc.usuari = usuari;
    }
     static String pwd;
    ...
    public static void setId(int id) {
        DesktopIniciFosc.id = id;
    }
    /**
     * Creates new form DesktopPrincipal
     */
    public DesktopIniciFosc() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DesktopIniciFosc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DesktopIniciFosc().setVisible(true);
            }
        });
    }
...
private void logOut(){
    ...
    try {
        ...
        Logger.getLogger(DesktopIniciFosc.class.getName()).log(Level.SEVERE, null, ex);
    }
